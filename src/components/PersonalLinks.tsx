...
function PersonalLinks() {
  return (
    <div className="h-full grid grid-cols-3 gap-4 items-end pb-[calc(var(--heading-size)*0.33)]">
...
const Email = (args: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" {...args}>
