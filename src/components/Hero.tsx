...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="text-right mt-[var(--container-sidespace)] mx-[var(--container-sidespace)] font-sans-tight text-[clamp(24px,3.30687831vw,56px)] leading-[1.1em] font-medium">
